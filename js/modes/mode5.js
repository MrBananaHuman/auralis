        ...
        notes.forEach((fullNote, idx) => {
            ...
            fretCells.forEach(cell => {
                ...
                if (marker) {
                    ...
                    const degreeColors = {
                        '1':  '#6366f1',  // Indigo  - Root
                        '3':  '#10b981',  // Emerald - Major 3rd
                        'b3': '#10b981',  // Emerald - Minor 3rd
                        '5':  '#f59e0b',  // Amber   - Perfect 5th
                        'b5': '#f59e0b',  // Amber   - Diminished 5th
                        '#5': '#f59e0b',  // Amber   - Augmented 5th
                        '7':  '#ec4899',  // Pink    - Major 7th
                        'b7': '#ec4899',  // Pink    - Minor 7th
                    };

                    const inShape = !!cellVoicingMap[key];
                    const finalColor = inShape
                        ? (degreeColors[deg] || 'rgba(255,255,255,0.3)')
                        : 'rgba(255, 255, 255, 0.08)';
                    const shadowGlow = inShape ? finalColor : 'transparent';

                    marker.style.background = finalColor;
                    marker.style.boxShadow = inShape ? `0 0 10px ${shadowGlow}` : 'none';
